    ...
    <div id="app">
        ...
        <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-2 shadow">
            <div class="row justify-content-between">
                <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="/">BOOLFOLIO di Diego G.</a>
        ...
        -->
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white {{ Route::currentRouteName() == 'admin.technologies.index' ? 'bg-secondary' : '' }}"
                                    ...
                                    <i class="fa-solid fa-memory"></i> TECH
                                </a>
                            </li>
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 background_style">
                    @yield('content')
                </main>
            </div>
        </div>
